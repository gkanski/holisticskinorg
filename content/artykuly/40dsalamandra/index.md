---
title: "Zastosowanie kwasów omega-3 w terapiach skór problematycznych"
date: 2024-05-10
draft: false
description: ""
showDate: true
tags: [Dominika Salamandra, Omega-3]
...
- W przypadku zaostrzeniu zmian AZS swój udział mają:komórki T, które wytwarzają IL4 czy INF-Y, oraz większa aktywność eozynofili, komórek tucznych, czy przeciwciała IGE. Z kwasów omega 3 wytwarzany jest przeciwzapalny mediator RvE1, który hamuje powyższe mediatory zapalne. Ponad to kwasy omega 3 mają zdolność obniżania IgE, hamują aktywność komórek tucznych, eozynofili czy komórek T, tym samym mogą łagodzić zmiany AZS.
- W przypadku łuszczycy dochodzi do akumulacji limfocytów Th1, Th17, Th22 w skórze, badania pokazują, że zarówno suplementacja jak i miejscowe stosowanie kwasów omega 3 zmniejsza stan zapalny, zaczerwienienie, nadmierną keratynizację oraz swędzenie zmian łuszczycowych. Kwasy omega 3 dodatkowo hamują cytokiny prozapalne takie jak IL1, IL6, IL8 czy TNF-L, które są odpowiedzialne za stan zapalny w przebiegu łuszczycy. Poprzez wpływ na zmniejszenie m.in TNF-L czy płytkopochodnego czynnika wzrostu (PDGF) zmniejszają proliferacją naczyniową w rozwijających się wykwitach łuszczycowych.To działanie jest również kluczowe w przypadku rumienia, czy trądziku różowatego.
- W przypadku przebarwień pochodna kwasu DHA - MaR1 zmniejsza obrzęk skóry oraz aktywację makrofagów,spowodowaną promieniowaniem UV, oraz hamuje apoptozę komórek naskórka wywołaną promieniowaniem UVB. Kwasy omega 3 hamują cytokiny prozapalne jak IL- 1B, TNF-L oraz stres oksydacyjny, który również ma udział w patogenezie przebarwień. Ponadto DHA hamuje MSH oraz aktywowaną tyrozynazę, oraz zwiększa degradację nadmiernej jej ilości, dzięki czemu zmniejsza możliwość pojawienia przebarwień. Kwasy omega 3 zmniejszają możliwość oparzenia skóry w wyniku działania promieniowania UVB, ponieważ wykazują wysoki potencjał przeciwzapalny.
- W przypadku starzenia się skóry swój udział mają metaloproteinazy,kwasy omega 3 mają zdolność hamowania MMP1 w fibroblastach skóry. Ponadto badania wykazały, że kwasy omega 3 spowalniają skracanie telomerów, które biorą udział w podziałach komórkowych i skracają się wraz z każdym podziałem oraz wiekiem.

## Podsumowanie
Kwasy Omega-3 wykazują wysoką aktywność biologiczną na poziomie molekularnym i komórkowym,dzięki czemu wpływają na funkcjonowanie komórek i tkanek, co przekłada się również na funkcjonowanie i wygląd skóry. Właściwości przeciwutleniające i przeciwzapalne kwasów omega-3 są niezwykle ważne w przypadku wielu dermatoz skórnych przebiegających ze stanem zapalnym. Właściwości te dają możliwości terapeutyczne, dzięki czemu znacząco można przyśpieszyć i poprawić efekty obecnych terapii, dlatego warto włączyć je do suplementacji u każdego pacjenta.

## Źródła
1. Huang TH, Wang PW, Yang SC, Chou WL, Fang JY. Cosmetic and Therapeutic Applications of Fish Oil's Fatty Acids on the Skin. Mar Drugs. 2018 Jul 30;16(8):256. doi: 10.3390/md16080256. PMID: 30061538; PMCID: PMC6117694.
